...
>
    ...
    >
        <path d="
        M353,9 L626.664028,170
        L626.664028,487
        L353,642
        L79.3359724,487
        L79.3359724,170
        L353,9
        Z" id="Polygon-1" stroke="#007FB2" stroke-width="6" ></path>
        <path d="
        M78.5,529
        L147,569.186414
        L147,648.311216
        ...
        L10,569.186414
        L78.5,529
        Z" id="Polygon-2" stroke="#EF4A5B" stroke-width="6" ></path>
...
<div class="message-box">
    <h1>419</h1>
    <p >.صفحه مورد نظر منقضی شده است</p>
    <div class="buttons-con">
        <div class="action-link-wrap">
            <a onclick="history.back(-1)" class="link-button link-back-button">بازگشت به صفحه قبل</a>
            <a href="{{url('/')}}" class="link-button">بازگشت به صفحه اصلی</a>
        </div>
    </div>
</div>
<!-- partial -->
