        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                    <!-- chat item -->
                    <div class="item">
                        <img src="{{asset("admincssjs/dist/img/user4-128x128.jpg")}}" alt="user image" class="online">
                    ...
                    <!-- chat item -->
                    <div class="item">
                        <img src="{{asset("admincssjs/dist/img/user6-128x128.jpg")}}" alt="user image" class="offline">
                    ...
                    <!-- chat item -->
                    <div class="item">
                        <img src="{{asset("admincssjs/dist/img/user5-128x128.jpg")}}" alt="user image" class="offline">
